(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('positioning'), require('rxjs'), require('rxjs/operators'), require('calendar-utils'), require('angular-draggable-droppable'), require('@angular/animations'), require('@angular/material/icon'), require('angular-resizable-element'), require('@angular/material/dialog'), require('@angular/forms'), require('date-fns/format'), require('@qc/date-round'), require('@angular/material'), require('@angular/material/select'), require('@angular/platform-browser'), require('@angular/platform-browser/animations'), require('ngx-material-timepicker'), require('@angular/material/button'), require('@angular/material/button-toggle'), require('calendar-utils/date-adapters/date-fns'), require('date-fns')) :
    typeof define === 'function' && define.amd ? define('neo-calendar', ['exports', '@angular/core', '@angular/common', 'positioning', 'rxjs', 'rxjs/operators', 'calendar-utils', 'angular-draggable-droppable', '@angular/animations', '@angular/material/icon', 'angular-resizable-element', '@angular/material/dialog', '@angular/forms', 'date-fns/format', '@qc/date-round', '@angular/material', '@angular/material/select', '@angular/platform-browser', '@angular/platform-browser/animations', 'ngx-material-timepicker', '@angular/material/button', '@angular/material/button-toggle', 'calendar-utils/date-adapters/date-fns', 'date-fns'], factory) :
    (global = global || self, factory(global['neo-calendar'] = {}, global.ng.core, global.ng.common, global.positioning, global.rxjs, global.rxjs.operators, global.calendarUtils, global.angularDraggableDroppable, global.ng.animations, global.ng.material.icon, global.angularResizableElement, global.ng.material.dialog, global.ng.forms, global.format, global.dateRound, global.ng.material, global.ng.material.select, global.ng.platformBrowser, global.ng.platformBrowser.animations, global.ngxMaterialTimepicker, global.ng.material.button, global.ng.material['button-toggle'], global.dateFns, global.dateFns$1));
}(this, (function (exports, core, common, positioning, rxjs, operators, calendarUtils, angularDraggableDroppable, animations, icon, angularResizableElement, dialog, forms, format, dateRound, material, select, platformBrowser, animations$1, ngxMaterialTimepicker, button, buttonToggle, dateFns, dateFns$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var EventEmitterService = /** @class */ (function () {
        function EventEmitterService() {
            this.eventChange = new core.EventEmitter();
        }
    ...
    var CalendarMonthModule = /** @class */ (function () {
        ...
        CalendarMonthModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, angularDraggableDroppable.DragAndDropModule, CalendarCommonModule, icon.MatIconModule],
                declarations: [
                    CalendarMonthViewComponent,
                    CalendarMonthCellComponent,
                    CalendarOpenDayEventsComponent,
    ...
    var CalendarModalComponent = /** @class */ (function () {
        ...
        CalendarModalComponent.prototype.ngOnInit = function () {
            ...
            var dateOut = dateRound.round(dateIn, interval);
            ...
            this.addEvents = new forms.FormGroup({
                ...
                fromDate: new forms.FormControl(new Date(), forms.Validators.required),
                toDate: new forms.FormControl('', forms.Validators.required),
                fromTime: new forms.FormControl(fromTime, forms.Validators.required),
                toTime: new forms.FormControl('', forms.Validators.required),
            });
            if (this.data) {
    ...
    var CalendarCommonHeaderComponent = /** @class */ (function () {
        function CalendarCommonHeaderComponent(dateAdapter, eventEmitterService, dialog) {
            ...
            this.viewDateChange = new core.EventEmitter();
            this.viewChange = new core.EventEmitter();
            this.setView = new core.EventEmitter();
            this.onAddEventClick = new core.EventEmitter();
            this.onEditEventClick = new core.EventEmitter();
            this.onDeleteEventClick = new core.EventEmitter();
            this.onAddEventSaveClick = new core.EventEmitter();
    ...
    exports.CalendarCommonHeaderComponent = CalendarCommonHeaderComponent;
    exports.CalendarCommonHeaderModule = CalendarCommonHeaderModule;
    ...
    exports.ɵd = CalendarEventTitleComponent;
    exports.ɵe = CalendarTooltipWindowComponent;
    exports.ɵf = CalendarTooltipDirective;
    exports.ɵg = CalendarPreviousViewDirective;
    exports.ɵh = CalendarNextViewDirective;
    exports.ɵi = CalendarTodayDirective;
    exports.ɵj = CalendarDatePipe;
    exports.ɵk = CalendarEventTitlePipe;
    exports.ɵl = CalendarA11yPipe;
    exports.ɵm = ClickDirective;
    exports.ɵn = KeydownEnterDirective;
    exports.ɵo = CalendarMonthCellComponent;
    exports.ɵp = CalendarMonthViewHeaderComponent;
    exports.ɵq = CalendarWeekViewHeaderComponent;
    exports.ɵr = CalendarWeekViewEventComponent;
    exports.ɵs = CalendarWeekViewHourSegmentComponent;
...
//# sourceMappingURL=neo-calendar.umd.js.map
